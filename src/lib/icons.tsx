...
export const Close = () => {
  return (
    <svg
      ...
      viewBox="0 0 640 640"
    >
      <path d="M205.3 205.3C211.6 199 221.8 199 228.1 205.3L320 297.2L411.9 205.3C418.2 199 428.4 199 434.7 205.3C441 211.6 441 221.8 434.7 228.1L342.8 320L434.7 411.9C441 418.2 441 428.4 434.7 434.7C428.4 441 418.2 441 411.9 434.7L320 342.8L228.1 434.7C221.8 441 211.6 441 205.3 434.7C199 428.4 199 418.2 205.3 411.9L297.2 320L205.3 228.1C199 221.8 199 211.6 205.3 205.3z" />
    </svg>
  );
};
